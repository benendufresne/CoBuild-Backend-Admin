...
const MESSAGES = {
  ERROR: {
    ...
    // categories specific
    SERVICE_CATEGORY_ALREADY_EXIST: {
      statusCode: HTTP_STATUS_CODE.BAD_REQUEST,
      type: "SERVICE_CATEGORY_ALREADY_EXIST",
    },
    SERVICE_CATEGORY_NOT_FOUND: {
      statusCode: HTTP_STATUS_CODE.URL_NOT_FOUND,
      type: "SERVICE_CATEGORY_NOT_FOUND",
    },
  ...
  SUCCESS: {
    ...
    JOB_LIST_EXPORTED: (data) => {
      return {
        statusCode: HTTP_STATUS_CODE.OK,
        type: "JOB_LIST_EXPORTED",
        data: data,
      };
    },
    JOB_TEMPLATE: (data) => {
    ...
    GET_SERVICE_CATEGORY_LIST: (data) => {
      return {
        statusCode: HTTP_STATUS_CODE.OK,
    ...
    GET_SERVICE_CATEGORY_DROPDOWN: (data) => {
      return {
        statusCode: HTTP_STATUS_CODE.OK,
        type: "GET_SERVICE_CATEGORY_DROPDOWN",
        data: data
      }
    },
    SCHEDULE_JOB: (data) => {
...
const MAIL_TYPE = {
  ...
  WELCOME_SUB_ADMIN: "WELCOME_SUB_ADMIN",
  EXPORT_JOB_LIST: "EXPORT_JOB_LIST",
